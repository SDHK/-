...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public bool __Gen_Delegate_Imp0(int p0)
		{
		...
		public bool __Gen_Delegate_Imp1(string p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(EventMachine.EventExecutor p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp6(string p0, string p1, InputKeys.InputKeyCodes p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(string p0, string p1, InputKeys.InputKeyCodes p2, InputKeys.InputKeyCodes p3, System.Collections.Generic.List<string> p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Predicate<int>(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(System.Predicate<string>))
			{
			    return new System.Predicate<string>(__Gen_Delegate_Imp1);
			}
		    ...
		    if (type == typeof(System.Action<EventMachine.EventExecutor>))
			{
			    return new System.Action<EventMachine.EventExecutor>(__Gen_Delegate_Imp5);
			}
		
		    if (type == typeof(System.Action<string, string, InputKeys.InputKeyCodes>))
			{
			    return new System.Action<string, string, InputKeys.InputKeyCodes>(__Gen_Delegate_Imp6);
			}
		
		    if (type == typeof(System.Action<string, string, InputKeys.InputKeyCodes, InputKeys.InputKeyCodes, System.Collections.Generic.List<string>>))
			{
			    return new System.Action<string, string, InputKeys.InputKeyCodes, InputKeys.InputKeyCodes, System.Collections.Generic.List<string>>(__Gen_Delegate_Imp7);
			}
