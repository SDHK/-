...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineColorWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 5, 4, 8, 4);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "A", _m_A);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_A(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    float _a = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.A( _a );
                        translator.PushUnityEngineColor(L, gen_ret);
