...
namespace InputKeys
{
    ...
    public class InputKeysManager : SingletonMonoBase<InputKeysManager>
    {
        ...
        /// </summary>
        public event Action<string, string, InputKeyCodes> recordUpdateEvent;

        /// <summary>
        /// 按键录制完成事件：(组名，键名，被替换组合键，记录的新组合键，与新组合键重复 的同组 键值名列表)
        /// </summary>
        public event Action<string, string, InputKeyCodes, InputKeyCodes, List<string>> recordDoneEvent;
